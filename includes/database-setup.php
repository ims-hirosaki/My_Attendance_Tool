...
function mat_create_tables() {
    ...
    $defaults = array(
        ...
        'mat_show_overnight_message'  => 1,
        'mat_show_break_message'      => 1,
        'mat_show_overtime_message'   => 1,
        'mat_show_midnight_message'   => 1,
        'mat_closing_day'             => 0,
        'mat_time_unit'               => 30,
        'mat_clock_in_unit'            => mat_get_time_unit(),
        'mat_clock_out_unit'           => mat_get_time_unit(),
...
function mat_migrate_existing_tables() {
    ...
    $additions = array(
        ...
        'clock_in_unit'     => "ADD COLUMN `clock_in_unit` SMALLINT NULL DEFAULT NULL COMMENT '打刻時点の始業丸め単位（0=なし）' AFTER `time_unit`",
        'clock_out_unit'    => "ADD COLUMN `clock_out_unit` SMALLINT NULL DEFAULT NULL COMMENT '打刻時点の終業丸め単位（0=なし）' AFTER `clock_in_unit`",
        'midnight_span_minutes'   => "ADD COLUMN `midnight_span_minutes` SMALLINT UNSIGNED NULL DEFAULT NULL COMMENT '深夜該当時間（分）。始業・終業から自動計算' AFTER `clock_out_unit`",
...
function mat_drop_tables() {
    ...
    $option_keys = array(
        ...
        'mat_allow_log_edit',
        'mat_show_overnight_message',
        'mat_show_break_message',
        'mat_show_overtime_message',
        'mat_show_midnight_message',
        'mat_closing_day',
