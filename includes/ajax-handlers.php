...
function mat_prepare_clockout_handler() {
    ...
    wp_send_json_success( array(
        ...
        'needs_overnight_confirm' => ( mat_clockout_message_enabled( 'overnight' ) && $target['overnight_candidate'] && $forced_date !== $row->work_date ),
        ...
        'needs_break_confirm'  => ( mat_clockout_message_enabled( 'break' ) && $standard_minutes !== null && $break_minutes !== (int) $standard_minutes ),
        'needs_overtime_confirm' => ( mat_clockout_message_enabled( 'overtime' ) && ! empty( $calc['overtime'] ) && $calc['overtime'] > 0 ),
        'needs_midnight_confirm' => ( mat_clockout_message_enabled( 'midnight' ) && $needs_midnight_confirm ),
